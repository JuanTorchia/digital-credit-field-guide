...
| Original educational X thread is mandatory              | Critical | `content/thread.md`                 | Ten posts published from `@Juanchi_AR`; canonical URL recorded | proven |
| Tag `@Apyx_Fi` and include `$APYX` naturally            | Critical | Posts 1 and 8                       | Exact-string validation plus blind editorial review            | proven |
| Human publishes thread and submits                      | Critical | `docs/human-actions.md`             | Explicit approval; X published; Superteam confirmed receipt    | proven |
...
| Exact Superteam copy                                    | High     | `docs/submission-copy.md`           | Public field-guide and X-thread URLs included                  | proven |
